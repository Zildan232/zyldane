...
document.addEventListener('click', function (event) {
    ...
    nameElement.textContent = 'cayank acu';
    nameElement.style.position = 'absolute';
    nameElement.style.left = `${event.clientX}px`;
    nameElement.style.top = `${event.clientY}px`;
    nameElement.style.fontSize = '24px';
    nameElement.style.color = 'pink';
    nameElement.style.pointerEvents = 'none';
    document.body.appendChild(nameElement);

    // Animasi elemen dengan anime.js
    anime({
        targets: nameElement,
        translateY: -50, // Naik ke atas
